...
<body class="font-poppins">
  <nav class="py-4 px-10">
    ...
    <div class="flex gap-x-10">
      ...
      <div class="flex gap-x-5 flex-none">
        ...
        </svg><a href="cart.php"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
          </svg></a><a href="profile.php">
  ...
  <div class="bg-[#F9BAC9] py-8 text-center relative mb-[30rem] h-[400px]">
    ...
    <div class="bg-[#FAE1F5] shadow-md absolute left-1/2 -translate-x-1/2 flex flex-col items-center mx-auto px-5 py-5 w-1/3">
      <img src="./assets/profile.png" alt="" class="w-32" />
      <p class="mx-auto underline text-sm font-bold mt-2">Edit Profile</p>
      <div class="flex flex-col self-start text-left mt-3 gap-y-5 w-full">
        <div>
          <p class="text-[#9F9F9F]">Nama</p>
          <input type="text" class="border border-[#FD4E5D] w-full rounded-sm h-8 px-5" value="Nurul Ariqah">
        </div>
        <div>
          <p class="text-[#9F9F9F]">Username Pengguna</p>
          <input type="text" class="border border-[#FD4E5D] w-full rounded-sm h-8 px-5" value="nurularqh">
        </div>
        <div>
          <p class="text-[#9F9F9F]">Tanggal Lahir</p>
          <input type="date" class="border border-[#FD4E5D] w-full rounded-sm h-8 px-5" value="2003-09-01">
        </div>
        <div>
          <p class="text-[#9F9F9F]">No. Telp</p>
          <input type="text" class="border border-[#FD4E5D] w-full rounded-sm h-8 px-5" value="+62 853-4950-2177">
        </div>
        <div>
          <p class="text-[#9F9F9F]">Password</p>
          <input type="password" class="border border-[#FD4E5D] w-full rounded-sm h-8 px-5" value="12345">
        </div>
      </div>
      <div class="flex gap-x-5 mt-5">
        <a href="profile.php" class="bg-[#FF69B4] text-white px-7 py-2 font-bold">Batal</a>
        <button class="btn-update bg-[#188D16] text-white px-7 py-2 font-bold">Update</button>
      </div>
    </div>
  </div>
