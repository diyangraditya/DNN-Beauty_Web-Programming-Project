...
<html lang="id">
	...
	<body class="font-poppins">
		...
		<div class="bg-[#F9BAC9] py-8 text-center relative mb-[30rem] h-[300px]">
			...
			<div
				class="bg-[#FAE1F5] shadow-md absolute left-1/2 -translate-x-1/2 flex flex-col items-center mx-auto px-5 py-12 w-1/3"
			>
				...
				<div class="flex flex-col self-start text-left mt-3 gap-y-5">
					...
					<div>
						...
						<p class="font-medium">01 September 2003</p>
					</div>
					<div>
						<p class="text-[#9F9F9F]">No. Telp</p>
						<p class="font-medium">+62 853-4950-2177</p>
					</div>
				</div>
				<button
					class="uppercase bg-[#FD4E5D] mt-8 px-12 py-4 text-white font-bold rounded-full"
				>
					Member Gold
				</button>
			</div>
