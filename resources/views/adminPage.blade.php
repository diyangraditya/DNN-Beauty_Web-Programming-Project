...
<body class="font-poppins">
  <nav class="py-4 px-10">
    ...
    <div class="flex gap-x-10">
      <ul class="flex flex-1 gap-x-5 uppercase justify-between">
        <li>
          <a class="hover:underline" href="homeAdmin.php">Home</a>
        </li>
        <li>
  ...
  <div class="bg-[#F9BAC9] py-8 text-center relative mb-[20rem] min-h-[400px]">
    ...
    <div class="bg-[#FAE1F5] shadow-md absolute left-1/2 -translate-x-1/2 flex flex-col items-center mx-auto px-5 py-5 w-2/3">
      <table class="bg-white w-full">
        ...
        <tbody>
          <tr>
            <td class="border-black border-r px-4 py-7">Nurul Ariqah</td>
            <td class="border-black border-r px-4 py-7">nurularqh</td>
            <td class="py-7">
              <a href="editProfileAdmin.php" class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 mx-2 underline">Edit</a>
              <button class="btn-delete bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 mx-2 underline">Delete</button>
            </td>
          </tr>
          <tr>
            <td class="border-black border-r px-4 py-7">Novia Rahmadhani</td>
            <td class="border-black border-r px-4 py-7">noviarp</td>
            <td class="py-7">
              <a href="editProfileAdmin.php" class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 mx-2 underline">Edit</a>
              <button class="btn-delete bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 mx-2 underline">Delete</button>
            </td>
          ...
          <tr>
            <td class="border-black border-r px-4 py-7">Diyang Raditya</td>
            <td class="border-black border-r px-4 py-7">diyangra</td>
            <td class="py-7">
              <a href="editProfileAdmin.php" class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 mx-2 underline">Edit</a>
              <button class="btn-delete bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 mx-2 underline">Delete</button>
            </td>
